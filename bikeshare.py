...
def display_raw_data(df):
    ...
    while True:
        if raw == 'no':
            ...
            raw = input("Do you want to see the next five rows in the data?\nIf you want to see the data enter 'yes', if you want to continue with the statistics enter 'no'\n").lower() # TO DO: convert the user input to lower case using lower() function
            i += 5
        else:
